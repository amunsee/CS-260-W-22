/*
using dijikstras algorithm for shortest path, and kruskals for Min Spanning tree
*/
#include <vector>
#include <string>
#include <iostream>
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
    //runtime of dijikstas should be O(ElogV) E-#edges, V-#of nodes/vertices
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //O(n)
    void print_list(vector <graphnode *> list){ //used for testing some stuff
...
//end of shortest path/supporting functions for it//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //min spanniing tree algorith  -- need all nodes in graph, need all edges of each node in graph, # of nodes in graph.
    void min_spanning_tree(){ //using kruskals algorithm runtime for kruskals should be O(ElogV) using adjacency lists
...
//-2 means dont add its redundant, -1 has no group, anything else i an existing group
            if(to_add.first != -2 && to_add.second != -2){//work on this once i get my other function sorted out, need to deal with creating new groups and joining groups, and adding the edges here.
                ...
                //add the edge here.
                mst_edges.push_back(make_pair(top.second.first, top.second.second));//update edges used int mst           
                mst_weight += top.first;//update mst weight cost
            }
    ...
    //O(n)
    bool check_contains(vector <string> group, string search_for){ //returns bool for if it found the item to search for or not
    ...
    //O(N)
    void mst_print(vector <pair <string, string>> mst){ //prints edges used to make mst
